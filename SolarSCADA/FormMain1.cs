    ...
    public partial class FormMain : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (serialPort1.IsOpen)
            {
                ...
                if (Math.Abs(DateTime.Now.Hour * 60 + DateTime.Now.Minute - req_data) >= 3.0)
                {
                    request_data();
                    req_data = DateTime.Now.Hour * 60 + DateTime.Now.Minute;
                }
        ...
        private void processData(object sender, EventArgs e)
        {
            ...
            {
                //method 1
                //indexofPV = Convert.ToSByte( portDataIn.IndexOf("PV"));
                //indexofPC = Convert.ToSByte( portDataIn.IndexOf("PC"));
                //indexofLV = Convert.ToSByte( portDataIn.IndexOf("LV"));
                //indexofLC = Convert.ToSByte( portDataIn.IndexOf("LC"));
                //indexofBV = Convert.ToSByte( portDataIn.IndexOf("BV"));
                //indexofBC = Convert.ToSByte( portDataIn.IndexOf("BC"));
                ////
                //pvVoltage = portDataIn.Substring(0, indexofPV);
                //pvCurrent = portDataIn.Substring(indexofPV + 2, (indexofPC - indexofPV) - 2);
                //loadVoltage = portDataIn.Substring(indexofPC + 2, (indexofLV - indexofPC) - 2);
                //loadCurrent = portDataIn.Substring(indexofLV + 2, (indexofLC - indexofLV) - 2);
                //batteryVoltage = portDataIn.Substring(indexofLC + 2, (indexofBV - indexofLC) - 2);
                //batteryCurrent = portDataIn.Substring(indexofBV + 2, (indexofBC - indexofBV) - 2);

                //method 2
                pvVoltage = portDataIn[2];
                pvCurrent = portDataIn[3];
                loadVoltage = portDataIn[4];
                loadCurrent = portDataIn[5];
                batteryVoltage = portDataIn[6];
                batteryCurrent = portDataIn[7];
                angel = portDataIn[8];
                ...
                rdV = randV.Next(-3, 3);
                rdI = randI.Next(-2, 2);
                pv2VoltageShow.Text = Convert.ToString(Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV);
                pv2CurrentShow.Text = Convert.ToString(Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI);
                pv2WattageShow.Text = Convert.ToString((Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV) * (Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI));
                angelpv2.Text = Convert.ToString(Double.Parse(angel, CultureInfo.InvariantCulture) + rand.Next(-3, 3));
                //PV3
                rdV = randV.Next(-3, 3);
                rdI = randI.Next(-2, 2);
                pv3VoltageShow.Text = Convert.ToString(Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV);
                pv3CurrentShow.Text = Convert.ToString(Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI);
                pv3WattageShow.Text = Convert.ToString((Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV) * (Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI));
                angelpv3.Text = Convert.ToString(Double.Parse(angel, CultureInfo.InvariantCulture) + rand.Next(-3, 3));
                //PV4
                rdV = randV.Next(-3, 3);
                rdI = randI.Next(-2, 2);
                pv4VoltageShow.Text = Convert.ToString(Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV);
                pv4CurrentShow.Text = Convert.ToString(Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI);
                pv4WattageShow.Text = Convert.ToString((Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV) * (Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI));
                angelpv4.Text = Convert.ToString(Double.Parse(angel, CultureInfo.InvariantCulture) + rand.Next(-3, 3));
                //PV5
                rdV = randV.Next(-3, 3);
                rdI = randI.Next(-2, 2);
                pv5VoltageShow.Text = Convert.ToString(Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV);
                pv5CurrentShow.Text = Convert.ToString(Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI);
                pv5WattageShow.Text = Convert.ToString((Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV) * (Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI));
                angelpv5.Text = Convert.ToString(Double.Parse(angel, CultureInfo.InvariantCulture) + rand.Next(-3, 3));
                //PV6
                rdV = randV.Next(-3, 3);
                rdI = randI.Next(-2, 2);
                pv6VoltageShow.Text = Convert.ToString(Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV);
                pv6CurrentShow.Text = Convert.ToString(Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI);
                pv6WattageShow.Text = Convert.ToString((Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV) * (Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI));
                angelpv6.Text = Convert.ToString(Double.Parse(angel, CultureInfo.InvariantCulture) + rand.Next(-3, 3));
                //PV7
                rdV = randV.Next(-3, 3);
                rdI = randI.Next(-2, 2);
                pv7VoltageShow.Text = Convert.ToString(Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV);
                pv7CurrentShow.Text = Convert.ToString(Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI);
                pv7WattageShow.Text = Convert.ToString((Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV) * (Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI));
                angelpv7.Text = Convert.ToString(Double.Parse(angel, CultureInfo.InvariantCulture) + rand.Next(-3, 3));
                //PV8
                rdV = randV.Next(-3, 3);
                rdI = randI.Next(-2, 2);
                pv8VoltageShow.Text = Convert.ToString(Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV);
                pv8CurrentShow.Text = Convert.ToString(Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI);
                pv8WattageShow.Text = Convert.ToString((Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV) * (Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI));
                angelpv8.Text = Convert.ToString(Double.Parse(angel, CultureInfo.InvariantCulture) + rand.Next(-3, 3));
                //PV9
                rdV = randV.Next(-3, 3);
                rdI = randI.Next(-2, 2);
                pv9VoltageShow.Text = Convert.ToString(Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV);
                pv9CurrentShow.Text = Convert.ToString(Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI);
                pv9WattageShow.Text = Convert.ToString((Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV) * (Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI));
                angelpv9.Text = Convert.ToString(Double.Parse(angel, CultureInfo.InvariantCulture) + rand.Next(-3, 3));
                //PV10
                rdV = randV.Next(-3, 3);
                rdI = randI.Next(-2, 2);
                pv10VoltageShow.Text = Convert.ToString(Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV);
                pv10CurrentShow.Text = Convert.ToString(Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI);
                pv10WattageShow.Text = Convert.ToString((Double.Parse(pvVoltage, CultureInfo.InvariantCulture) + rdV) * (Double.Parse(pvCurrent, CultureInfo.InvariantCulture) + rdI));
                angelpv10.Text = Convert.ToString(Double.Parse(angel, CultureInfo.InvariantCulture) + rand.Next(-3, 3));
                //end Gia lap
                ...
                pv1WattageShow.Text = pvWattageShow.Text.ToString();
                ...
                batteryLevel = Double.Parse(batteryVoltage, CultureInfo.InvariantCulture) * 2;
                ...
                gio = Convert.ToDouble(DateTime.Now.Hour.ToString());
                phut = Convert.ToDouble(DateTime.Now.Minute.ToString());
                realtime = gio + phut / 60.0;
        ...
        private void send_date()
        {
            ...
            if (serialPort1.IsOpen)
            {
                if (checkCustom.CheckState == CheckState.Unchecked)
                {
                    ...
                    //dayofyear
                    //portdataOUT = DateTime.Now.DayOfYear.ToString();
                    portDataOut = "g0|n0|0|" + DateTime.Now.ToString("HH|mm|ss|dd|MM|yyyy|");
                   // portDataOut = "TG" +"|" + DateTime.Now.ToString("dd") + "|" + DateTime.Now.ToString("MM") + "|" + DateTime.Now.ToString("yyyy") + 
                ...
                if (checkCustom.CheckState == CheckState.Checked)
                {
                    ...
                    if (serialPort1.IsOpen)
                    {
                        ...
                        portDataOut = "g0|n0|0|" + textBox_ngay.Text + "|" + textBox_thang.Text + "|" + textBox_nam.Text + "|" + textBox_gio.Text +
                            "|" + textBox_phut.Text + "|" + textBox_giay.Text + "|";
                        serialPort1.WriteLine(portDataOut);
                    }
                }
        ...
        {   
            if (serialPort1.IsOpen)
            {
                ...
                portDataOut = "g0|n0|1|" + textBox_kinhDo.Text + "|" + textBox_viDo.Text + "|";
                serialPort1.WriteLine(portDataOut);
            }
            else
            {
        ...
        private void request_data()
        {
            ...
            if (serialPort1.IsOpen)
            {
                for (int i = 0; i < 10; i++)
                {
                    portDataOut = String.Format("g0|n{0}|3|Request|", i);
                    serialPort1.WriteLine(portDataOut);
                    //wait = DateTime.Now.Second;
                    //while (check == 0)
                    //{
                    // if((DateTime.Now.Second-wait)>=5)
                    //    {
                    //        mess = String.Format("Node {0} khong co phan hoi", i);
